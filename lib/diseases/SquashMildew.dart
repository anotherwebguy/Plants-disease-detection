...
class SquashMildew extends StatefulWidget {
  SquashMildew({Key key, this.title}) : super(key: key);
  final String title;
        ...
        body: ListView(
          children: <Widget>[
                ...
                SizedBox(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Carousel(
                          images: [
                            AssetImage('assets/squash.jpg'),
                            // Photo from https://unsplash.com/photos/2d4lAQAlbDA
                            AssetImage('assets/squash2.jpg'),
                            // Photo from https://unsplash.com/photos/FqqiAvJejto
                            AssetImage('assets/squash3.jpg'),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text('Podosphaera xanthii', style: new TextStyle(fontSize: 15.0,),),
            ...
            Padding(
              ...
              child: Text('1. Symptoms usually appear later in the growing season on outdoor plants. Powdery mildew starts on young leaves as raised blister-like areas that cause leaves to curl, exposing the lower leaf surface.\n\n2. Infected leaves become covered with a white to gray powdery growth, usually on the upper surface; unopened flower buds may be white with mildew and may never open.\n\n3. Leaves of severely infected plants turn brown and drop. The disease prefers young, succulent growth; mature leaves are usually not affected.\n\n4. Fungal spores overwinter inside leaf buds and other plant debris. Wind, water and insects transmit the spores to other nearby plants.',textAlign: TextAlign.justify, style: TextStyle(
                  fontSize: 17,
                  fontFamily: 'Raleway'),),
            ),
            Padding(
