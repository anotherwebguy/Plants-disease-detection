        ...
        body: ListView(
          children: <Widget>[
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text('Tomato Yellow Leaf Curl Virus', style: new TextStyle(fontSize: 15.0,),),
            ...
            Padding(
              ...
              child: Text('1. The disease can be easily recognized when tomato plants are infected at the seedling stage. TYLCV causes severe stunting of young leaves and shoots, resulting in bushy growth of infected seedlings.\n\n2. Affected plants exhibit upward and inward rolling of the leaf margins, interveinal yellowing of leaflets and marked stunting. The virus reduces fruit set considerably, especially when infection takes place before the flowering stage.\n\n3. There are no noticeable symptoms on fruits derived from infected plants. Flowers formed on infected plants commonly do not develop and fall off (abscise).\n\n4. Fruit production is dramatically reduced, particularly when plants are infected at an early age, and it is not uncommon for losses of 100% to be experienced in fields with heavily infected plants.',textAlign: TextAlign.justify, style: TextStyle(
                  fontSize: 17,
                  fontFamily: 'Raleway'),),
            ),
            Padding(
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14, right: 14),
              child: Text('The primary way the virus is spread short distances is by Bemisia whitefly species. Over long distance, the virus is primarily spread through the movement of infected plants, especially tomato transplants. Because it can take up to 3 weeks for disease symptoms to develop, infected symptomless plants could be unknowingly transported. The virus also can be moved long distance by virus-carrying whiteflies that are transported on tomatoes or other plants (e.g., ornamentals) or via high winds, hurricanes, or tropical storms. ',textAlign: TextAlign.justify,
                style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14,right: 14),
              child: Text('1. Use a neonicotinoid insecticide, such as dinotefuran (Venom) imidacloprid (AdmirePro, Alias, Nuprid, Widow, and others) or thiamethoxam (Platinum), as a soil application or through the drip irrigation system at transplanting of tomatoes or peppers.\n\n2. A highly UV-reflective mulch (metalized) and low rates of crop oil (0.25 -0.50 percent) can be used as whitefly repellents to reduce whitefly feeding and virus transmission.\n\n3. Sanitation is very important for preventing the migration of whitefly adults and the spread of TYLCV.\n\n4. Rogue tomato or pepper plants with early symptoms of TYLCV can be removed from fields by placing infected-looking plants in plastic bags immediately at the beginning season, especially during first three to four weeks.',textAlign: TextAlign.justify,
                style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
