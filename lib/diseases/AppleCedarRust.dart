...
class AppleCedarRust extends StatefulWidget {
  AppleCedarRust({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _AppleCedarRustState createState() => _AppleCedarRustState();
}

class _AppleCedarRustState extends State<AppleCedarRust> {
  @override
    ...
    return Scaffold(
        body: ListView(
          children: <Widget>[
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text('Gymnosporangium juniperi-virginianae', style: new TextStyle(fontSize: 15.0,),),
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14,right: 14),
              child: Text('Cool temperatures (60-80° F) and high humidity favor disease development.',textAlign: TextAlign.justify,
                style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14,right: 14),
              child: Text('1. A Mixture of Sulfur and Pyrethins ,These two classic compounds are available in a pre-mixed spray known as Bonide® Orchard Spray.This spray controls both fungi and insects and is certified organic. Beware that it can harm beneficial insects in the area along with pests.  \n\n2. Liquid CopperYou can treat them with a solution of copper at least four times. Use 0.5 to 2.0 ounces of copper per gallon of water.It’s best to start with this treatment as a preventative early in the spring before the trees are showing signs of infection, or just as they begin showing symptoms.\n\n3. Biofungicides: There is a strain of bacteria that is effective at treating cedar apple rust on apple trees. It is a special strain of Bacillus subtilis ',
                textAlign: TextAlign.justify,style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
