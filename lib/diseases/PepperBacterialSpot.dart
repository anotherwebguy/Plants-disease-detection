...
class PepperBacterialSpot extends StatefulWidget {
  PepperBacterialSpot({Key key, this.title}) : super(key: key);
  final String title;
        ...
        body: ListView(
          children: <Widget>[
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text('Xanthomonas campestris pv. vesicatoria', style: new TextStyle(fontSize: 15.0,),),
            ...
            Padding(
              ...
              child: Text('Pepper leaves have small (<1/8 inch), brown, circular spots that do not have a yellow halo and centers do not fall out. Small, brown, circular spots may also occur on stems and the fruit calyx. Fruit spots are ¼ inch, slightly raised, brown and scabby. Pepper fruit spots often occur on the stem-end of the fruit. Spots occur on green and red fruit but do not result in rot. Fruit spots (up to 0.5 cm, 0.2 in.) begin as pale-green, water-soaked areas, which eventually become raised, brown, and roughened on pepper (Figure 3) and tomato (Figure 11) fruit. Spots may provide entrance points for various fungal and other bacterial invaders that can cause secondary fruit rots.',textAlign: TextAlign.justify, style: TextStyle(
                  fontSize: 17,
                  fontFamily: 'Raleway'),),
            ),
            Padding(
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14, right: 14),
              child: Text('It survives in high temperatures (75°F to 86°F) and high humidity with frequent rainfall/overhead irrigation. Bacteria survive on plant debris in the soil for one to two years, but will not survive once plant debris is broken down. Introduction is primarily on infected seed or infected transplants. Even seedlings that do not show symptoms may be infected and will show symptoms later in the growing season. Bacteria can spread from plant to plant by tools, workers’ hands, or through splashing rain or irrigation water. Between rotations, the bacteria may survive on tomato or pepper volunteer plants.',textAlign: TextAlign.justify,
                style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14,right: 14),
              child: Text('Pesticides are available to protect pepper from bacterial spot. Applications should be made when environmental conditions favor disease to be the most effective and repeated according to label instructions.',textAlign: TextAlign.justify,
                style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
