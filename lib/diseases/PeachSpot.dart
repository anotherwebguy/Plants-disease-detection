    ...
    return Scaffold(
        body: ListView(
          children: <Widget>[
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text('Xanthomonas campestris pv. pruni', style: new TextStyle(fontSize: 15.0,),),
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14,right: 14),
              child: Text('1. Bactericides are available for suppression of bacterial spot. Initial treatments focus on suppression of leaf infection and later on protection of fruit as they emerge from the shuck.\n\n2. Bactericide treatment may not be sufficient to eliminate symptoms under conditions very favorable for disease development. Compounds available for use on peach and nectarine for bacterial spot include copper, oxytetracycline (Mycoshield and generic equivalents), and syllit+captan; however, repeated applications are typically necessary for even minimal disease control.\n\n3. Oxytetracycline is generally considered the most effective compound and the least prone to phytotoxicity problems (damage to plant tissue), but also perhaps most likely to lose effectiveness with the appearance of bacterial strains with resistance.',textAlign: TextAlign.justify,
                style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
