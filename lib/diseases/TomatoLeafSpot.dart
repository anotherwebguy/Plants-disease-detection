    ...
    return Scaffold(
        body: ListView(
          children: <Widget>[
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text('Septoria lycopersici', style: new TextStyle(fontSize: 15.0,),),
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14, right: 14),
              child: Text('1. Septoria leaf spot is favored by warm, wet, humid conditions. Although the fungus can survive in or on seed and in weed hosts, the main source of inoculum is from leaf fragments and other plant debris from diseased plants that overwinter in the soil.\n\n2. Under wet conditions, spores (also called conidia) of the fungus are produced in the pycnidia. These spores are spread to healthy tomato leaves by windblown water, splashing rain, overhead irrigation systems, hands and clothing of pickers, cultivation equipment, and several types of insects such as Colorado potato beetles, flea beetles, tomato worms, and aphids.\n\n3. Following this initial spread and when free moisture is present on the leaves, the spores germinate, infect the tomato tissues, and spots usually appear within 5 days. Pycnidia subsequently develop in these new spots, more spores are produced, secondary cycles of infection begin, and the disease spreads.',textAlign: TextAlign.justify,
                style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14,right: 14),
              child: Text('1. Fungicides are very effective for control of Septoria leaf spot and applications are often necessary to supplement the control strategies previously outlined.\n\n2. The fungicides chlorothalonil and mancozeb are labeled for homeowner use. Since these are protectant materials, they should be applied as soon as symptoms are observed and repeated as necessary when conditions are favorable for disease development and spread.\n\n3. The fungicide labels contain information on dosage rates, spray intervals, days-to-harvest intervals, and safety precautions.',textAlign: TextAlign.justify,
                style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
