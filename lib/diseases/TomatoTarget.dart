...
class TomatoTarget extends StatefulWidget {
  TomatoTarget({Key key, this.title}) : super(key: key);
  final String title;
    ...
    return Scaffold(
        body: ListView(
          children: <Widget>[
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text('Corynespora cassiicola', style: new TextStyle(fontSize: 15.0,),),
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14, right: 14),
              child: Text('This fungus has a broad host range on which it can survive. Infection occurs readily during periods of mild temperatures between 16-32°C (61-90°F) and high moisture. Fungal spores. which often form abundantly on the surface of infected tissues, are spread by air movement and rainfall.',textAlign: TextAlign.justify,
                style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
            ...
            Padding(
              padding: EdgeInsets.only(top: 20, bottom: 20, left: 14,right: 14),
              child: Text('Warm wet conditions favour the disease such that fungicides are needed to give adequate control. The products to use are chlorothalonil, copper oxychloride or mancozeb. Treatment should start when the first spots are seen and continue at 10-14-day intervals until 3-4 weeks before last harvest. It is important to spray both sides of the leaves.',textAlign: TextAlign.justify,
                style: TextStyle(
                    fontSize: 17,
                    fontFamily: 'Raleway'),
              ),
